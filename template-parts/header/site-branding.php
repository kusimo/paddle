...
<?php 
	if ( ( is_header_video_active() && has_header_video() ) || has_header_image() ) :
		...
		$paddle_banner_title 			= get_theme_mod( 'header_banner_title' );
		$paddle_banner_description 		= get_theme_mod( 'header_banner_description' );
	...
	<div class="home-banner vh">
		...
		<div class="home-banner-content outer content-<?php echo esc_attr( paddle_banner_align() ); ?>">
			<div class="board">
				...
				<header>
					<h1>
					<?php if( '' !== $paddle_banner_title ) echo esc_html( $paddle_banner_title ); ?>
					</h1>
				</header>

				<p class="home-banner-summary">
					<?php if( '' !== $paddle_banner_description ) echo esc_attr( get_theme_mod( 'header_banner_description' ) ); ?>
				</p>
				...
				<div class="home-banner-cta-button-container group-btn <?php echo esc_attr( paddle_banner_btncss() ); ?>">
					...
					<a href="<?php echo ( $paddle_banner_btn_1_link  ? esc_attr( $paddle_banner_btn_1_link ) : '' ); ?>" class="btn btn-primary no-rounded-right">
					...
					<a href="<?php echo ( $paddle_banner_btn_2_link  ? esc_attr( $paddle_banner_btn_2_link ) : '' ); ?>" class="btn bg-white no-rounded-left">
