...
if ( ! function_exists( 'paddle_generate_defaults' ) ) {
	function paddle_generate_defaults() {
		$customizer_defaults = array(
			...
			'paddle_menu_items_alignment'             => 'center',
			'paddle_menu_bgcolor'                     => '#FFFFFF',
			'menu_container_bg_color'				  => '#FFFFFF',
			...
			'banner_button_padding'					  => '10,20,10,20,0',
			...
			'menu_cta_bgcolor'						  => get_theme_mod( 'paddle_theme_color_buttons', '#2a3a51' ),
			'menu_cta_link_color'					  => get_theme_mod( 'paddle_theme_color_links', '#FFFFFF' ),
			'menu_cta_link_hover_color'			      => get_theme_mod( 'paddle_theme_color_links_hover', '#0357ab' ),
			'menu_cta_link_border_color'			  => get_theme_mod( 'paddle_theme_color_buttons', '#2a3a51' ),
			'menu_cta_bg_opacity'			  		  => 0,
			'menu_cta_padding'			  		      => '10,10,10,10,0',
			...
			'banner_header_content_spacing'			=> 9,
			'paddle_banner_header_bg_color'           => '#ffffff',
			'hero_image'                              => 0,
