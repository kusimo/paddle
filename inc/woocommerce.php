...
function paddle_woocommerce_scripts() {
	wp_enqueue_style( 'paddle-woocommerce-style', get_template_directory_uri() . '/woocommerce.css', array(), PADDLE_VERSION );
 ...
 *
	<?php
		if ( function_exists( 'paddle_woocommerce_header_cart' ) ) {
			paddle_woocommerce_header_cart();
		}
	?>
 */
	...
	function paddle_woocommerce_header_cart() {
		...
		<ul id="site-header-cart" class="site-header-cart">
			<li class="<?php echo esc_attr( $class ); ?>">
				<?php paddle_woocommerce_cart_link(); ?>
			</li>
			<li>
				<?php
				$instance = array(
